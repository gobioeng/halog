...
class FileProcessingWorker(QThread):
    ...
    progress_update = pyqtSignal(float, str, int, int, int, int)  # percentage, message, lines_processed, total_lines, bytes_processed, total_bytes
    ...
    def run(self):
        ...
        try:
            ...
            self.progress_update.emit(0, "Starting file processing...", 0, 0, 0, self.file_size)
            ...
            self.progress_update.emit(90, "Inserting records into database...", 
    ...
    def _progress_callback(self, percentage: float, message: str):
        ...
        estimated_total_lines = max(lines_processed, int(self.file_size / 100))  # Rough estimate
        ...
        self.progress_update.emit(
            percentage, message, 
            lines_processed, estimated_total_lines,
